    ...
    <>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <PageHeader
          ...
          description="Double-entry bookkeeping, general ledger, trial balance, and financial statements."
        />
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button asChild size="sm" variant="outline" className="gap-1.5 rounded-xl">
            <Link href={`${base}/ledger`}>
              <BookOpen className="h-3.5 w-3.5" />
              General Ledger
            </Link>
          </Button>
          <Button asChild size="sm" className="gap-1.5 rounded-xl bg-violet-600 hover:bg-violet-700 text-white">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link href={`${base}/journal`} className="block group">
            ...
            <Link href={`${base}/accounts`} className="block group">
              <Card className="rounded-2xl transition-all hover:border-violet-500 hover:shadow-md h-full">
                <CardContent className="p-5 flex items-start gap-3.5">
                  <div className="rounded-xl p-3 bg-violet-500/10 text-violet-600 shrink-0">
