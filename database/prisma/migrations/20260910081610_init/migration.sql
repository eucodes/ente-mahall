-- CreateEnum
CREATE TYPE "PlatformRole" AS ENUM ('SUPER_ADMIN', 'PLATFORM_STAFF', 'PLATFORM_SUPPORT');
...
-- CreateIndex
CREATE INDEX "tenant_memberships_tenantId_isActive_idx" ON "tenant_memberships"("tenantId", "isActive");
